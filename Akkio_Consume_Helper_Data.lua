...
Akkio_Consume_Helper_Data.allBuffs = {
  ...
  { name = "Arcane Intellect",           icon = "Interface\\Icons\\Spell_Holy_MagicalSentry",    buffIcon = "Interface\\Icons\\Spell_Holy_MagicalSentry",       raidbuffIcon = "Interface\\Icons\\Spell_Holy_ArcaneIntellect",           canBeAnounced = true},
  ...
  { name = "Flask of the Titans",        icon = "Interface\\Icons\\INV_Potion_62",              buffIcon = "Interface\\Icons\\INV_Potion_62",                                                                                            canBeAnounced = false, duration = 7200 },
  { name = "Flask of Supreme Power",     icon = "Interface\\Icons\\INV_Potion_41",              buffIcon = "Interface\\Icons\\INV_Potion_41",                                                                                            canBeAnounced = false, duration = 7200 },
  { name = "Flask of Distilled Wisdom",  icon = "Interface\\Icons\\INV_Potion_97",              buffIcon = "Interface\\Icons\\INV_Potion_97",                                                                                            canBeAnounced = false, duration = 7200 },
                                  
  { header = true,                       name = "Elixirs & Juju" },
  { name = "Elixir of the Mongoose",     icon = "Interface\\Icons\\Inv_potion_32",              buffIcon = "Interface\\Icons\\INV_Potion_32",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Elixir of Fortitude",        icon = "Interface\\Icons\\Inv_potion_43",              buffIcon = "Interface\\Icons\\INV_Potion_44",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Elixir of Giants",           icon = "Interface\\Icons\\Inv_Potion_61",              buffIcon = "Interface\\Icons\\INV_Potion_61",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Elixir of Superior Defense", icon = "Interface\\Icons\\Inv_Potion_66",              buffIcon = "Interface\\Icons\\INV_Potion_86",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Elixir of Shadow Power",     icon = "Interface\\Icons\\Inv_Potion_46",              buffIcon = "Interface\\Icons\\INV_Potion_46",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Elixir of Greater Firepower",icon = "Interface\\Icons\\Inv_Potion_60",              buffIcon = "Interface\\Icons\\INV_Potion_60",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Mageblood Potion",           icon = "Interface\\Icons\\Inv_Potion_45",              buffIcon = "Interface\\Icons\\INV_Potion_45",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Gift of Arthas",             icon = "Interface\\Icons\\Inv_Potion_28",              buffIcon = "Interface\\Icons\\Spell_Shadow_FingerOfDeath",                                                                               canBeAnounced = false, duration = 1800 },
  { name = "Greater Arcane Elixir",      icon = "Interface\\Icons\\Inv_Potion_25",              buffIcon = "Interface\\Icons\\INV_Potion_25",                                                                                            canBeAnounced = false, duration = 3600 },
  { name = "Juju Might",                 icon = "Interface\\Icons\\INV_Misc_MonsterScales_07",  buffIcon = "Interface\\Icons\\INV_Misc_MonsterScales_07",                                                                                canBeAnounced = false, duration = 1800 },
  { name = "Juju Power",                 icon = "Interface\\Icons\\INV_Misc_MonsterScales_11",  buffIcon = "Interface\\Icons\\INV_Misc_MonsterScales_11",                                                                                canBeAnounced = false, duration = 1800 },
  { name = "Winterfall Firewater",       icon = "Interface\\Icons\\INV_Potion_92",              buffIcon = "Interface\\Icons\\INV_Potion_92",                                                                                            canBeAnounced = false, duration = 1200 },
  { name = "Spirit of Zanza",            icon = "Interface\\Icons\\INV_Potion_30",              buffIcon = "Interface\\Icons\\INV_Potion_30",                                                                                            canBeAnounced = false, duration = 7200 },
  { name = "Dreamshard Elixir",          icon = "Interface\\Icons\\INV_Potion_113",             buffIcon = "Interface\\Icons\\INV_Potion_25",                                                                                            canBeAnounced = false, duration = 3600 },
  --figure out soloution to dreamshard elxir using same icon as greater arcane elixir.

  { header = true,                       name = "Food & Drinks" },
  { name = "Smoked Desert Dumplings",    icon = "Interface\\Icons\\Inv_Misc_Food_64",           buffIcon = "Interface\\Icons\\Spell_Spell_Misc_Food",                                                                                    canBeAnounced = false, duration = 900 },
  { name = "Grilled Squid",              icon = "Interface\\Icons\\Inv_Misc_Fish_13",           buffIcon = "Interface\\Icons\\INV_Gauntlets_19",                                                                                         canBeAnounced = false, duration = 900 },
  { name = "Nightfin Soup",              icon = "Interface\\Icons\\Inv_Drink_17",               buffIcon = "Interface\\Icons\\Spell_Nature_Manaregentotem",                                                                              canBeAnounced = false, duration = 900 },
  { name = "Runn Tum Tuber Surprise",    icon = "Interface\\Icons\\Inv_Misc_Food_63",           buffIcon = "Interface\\Icons\\INV_Misc_Organ_03",                                                                                        canBeAnounced = false, duration = 900 },
  { name = "Dirge's Kickin' Chimaerok Chops", icon = "Interface\\Icons\\Inv_Misc_Food_65",      buffIcon = "Interface\\Icons\\INV_Boots_Plate_03",                                                                                       canBeAnounced = false, duration = 900 },
  { name = "Hardened Mushroom",         icon = "Interface\\Icons\\INV_mushroom_15",             buffIcon = "Interface\\Icons\\INV_Boots_Plate_03",                                                                                       canBeAnounced = false, duration = 900 },
  { name = "Power Mushroom",            icon = "Interface\\Icons\\INV_mushroom_14",             buffIcon = "Interface\\Icons\\Spell_Spell_Misc_Food",                                                                                       canBeAnounced = false, duration = 900 },
